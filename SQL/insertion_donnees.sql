-- Table des artistes
INSERT INTO artiste VALUES (0, "Dupont", "Jacques", TO_DATE("1997-10-24", "YYYY-MM-DD"), "La fête à la maison", "06-18-18-18-18")
INSERT INTO artiste VALUES (1, "Jibougné", "Léo", TO_DATE("1994-04-14", "YYYY-MM-DD"), "La fête à la maison", "06-28-18-18-18")
INSERT INTO artiste VALUES (2, "Latisane", "Nicolette", TO_DATE("1947-10-24", "YYYY-MM-DD"), "Ici c'est parti", "06-18-28-18-18")
INSERT INTO artiste VALUES (3, "Natoo", "Hugues", TO_DATE("1992-10-24", "YYYY-MM-DD"), "Ici c'est parti", "07-38-18-18-18")
INSERT INTO artiste VALUES (4, "Haroun", "Léa", TO_DATE("1897-10-24", "YYYY-MM-DD"), "Ici c'est parti", "07-18-18-18-18")
...
-- Table des numeros
INSERT INTO numero VALUES (0, "La machine à sous", "Magie", "Ceci est un résumé du numéro", 10, 30, 8, "Ceci est une évaluation du numéro")
INSERT INTO numero VALUES (1, "TOP 10 des éléphants", "Zoo", "Ceci est un résumé du numéro", 0, 30, 3, "Ceci est une évaluation du numéro")
INSERT INTO numero VALUES (2, "Une corde c'est bien, deux c'est mieux", "Voltige", "Ceci est un résumé du numéro", 2, 30, 5, "Ceci est une évaluation du numéro")
INSERT INTO numero VALUES (3, "J'ai un grand sourire", "Clown", "Ceci est un résumé du numéro", 1, 30, 8, "Ceci est une évaluation du numéro")
INSERT INTO numero VALUES (4, "Imaginez la licorne", "Zoo", "Ceci est un résumé du numéro", 14, 30, 10, "Ceci est une évaluation du numéro")
...
INSERT INTO pseudo_artiste VALUES (2, "L'anglaise")
